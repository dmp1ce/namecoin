...
class CStandardHooks : public CHooks
{
public:
...
void CStandardHooks::AddToWallet(CWalletTx& tx)
{
}

bool CStandardHooks::CheckTransaction(const CTransaction& tx)
{
    return true;
}
...
short unsigned int GetDefaultPort()
{
